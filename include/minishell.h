...
#define UNEXPECTED_CHAR_WARNING                                                \
  "Warning: Unexpected character during tokenization."
...
void assign_redirect_out_append(const char **str_ptr, t_data *data,
                                size_t *idx);
void assign_redirect_in_out_heredoc_append(const char **str_ptr, t_data *data,
                                           size_t *idx);
...
void append_other_args(t_ast_node *node, char *argm, t_data *data);
