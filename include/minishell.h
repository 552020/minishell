...
t_ast_node				*parser(int start, int end,
							t_data *data);
t_ast_node				*build_cmd_node(int start, int end,
							t_data *data);
...
void					handle_cmd_and_args(int idx,
							t_ast_node **node, t_data *data);
void					handle_simple_redirects(int idx,
							t_ast_node **node, t_data *data);
void					handle_double_redirects(int idx,
							t_ast_node **node, t_data *data);
